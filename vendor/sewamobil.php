        ...
        <div class="container" h-100>
            <div class="row" h-100>
                <div class="col-md-6 hero-tagline my-auto">
                    <img src="img/bg_mobil.jpg" alt="" class="position-absolute end-0 bottom-0 img-hero">
                    <h1>Mencari Mobil Untuk Acara Pernikahan ?</h1>
                    <p>Temukan Rental Mobil Pernikahan terbaik disini...</p>
          ...
          <div class="container">
              <div class="row">
                <?php
                  ...
                  FROM vendor, jenis_layanan WHERE jenis_layanan.nama_layanan = 'sewamobil'
                ...
                WHERE rating IS NOT NULL AND booking.id_vendor = '$id' AND booking.jenis_layanan = jenis_layanan.nama_layanan AND booking.jenis_layanan = 'sewamobil'");
