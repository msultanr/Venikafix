        ...
        <div class="container" h-100>
          <div class="row" h-100>
            <div class="col-md-6 hero-tagline my-auto">
              ...
              <h1>Bingung Cari Dekorasi Pernikahan ?</h1>
              <p>Temukan dekorasi pernikahan terbaik disini...</p>
      ...
      <section id="dekorasi">
          <div class="container">
              <div class="row">
                ...
                WHERE rating IS NOT NULL AND booking.id_vendor = '$id' AND booking.jenis_layanan = jenis_layanan.nama_layanan AND booking.jenis_layanan = 'Dekorasi'");
