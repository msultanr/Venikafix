        ...
        <div class="container" h-100>
            <div class="row" h-100>
                <div class="col-md-6 hero-tagline my-auto">
                    <img src="img/bg_gedung_pernikahan.jpg" alt="" class="position-absolute end-0 bottom-0 img-hero">
                    <h1>Hari Spesial Di Tempat Yang Spesial !</h1>
                    <p>Temukan Gedung Pernikahan terbaik disini...</p>
          ...
          <div class="container">
              <div class="row">
                <?php
                  ...
                  FROM vendor, jenis_layanan WHERE jenis_layanan.nama_layanan = 'gedung'
...
$kecamatan = preg_replace('/(?<!\ )[A-Z]/', ' $0', $kecamatan);
                ...
                WHERE rating IS NOT NULL AND booking.id_vendor = '$id' AND booking.jenis_layanan = jenis_layanan.nama_layanan AND booking.jenis_layanan = 'gedung'");
